...
def speed_convert(ui):
    ...
    #     input_num = Decimal(ui.lineEdit_input_speed.text())
    #     input_time = time_dict[ui.comboBox_in_time.currentText()]
    #     input_length = length_dict[ui.comboBox_in_length.currentText()]
    #     print(input_num,input_time,input_length)
    #     print(type(input_num),type(input_time),type(input_length))
    #
    #     out_time = time_dict[ui.comboBox_out_time.currentText()]
    #     out_length = length_dict[ui.comboBox_out_length.currentText()]
    #     print(type(out_time),type(out_length))
    #
    #     p1 = input_num
    #     p2 = input_length/out_length
    #     p3 = out_time/input_time
    #
    #     print(type(p1),type(p3),type(p3))
    #
    #     ui.lineEdit_out_speed.setText(str("{:.10f}".format(p1*p2*p3)))
